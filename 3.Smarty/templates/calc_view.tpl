        ...
        <form action="calc.php" method="post" style="max-width: 600px; margin: 0 auto; text-align: left;">
            <div class="row gtr-50">
                <div class="col-12">
                    ...
                    <input type="text" name="kwota" id="kwota" placeholder="np. 200000" value="{$kwota|default:''}" />
                </div>
                
                <div class="col-12">
                    <label for="lata">Liczba lat:</label>
                    <input type="text" name="lata" id="lata" placeholder="np. 15" value="{$lata|default:''}" />
                </div>
                
                <div class="col-12">
                    <label for="oprocentowanie">Oprocentowanie roczne (%):</label>
                    <input type="text" name="oprocentowanie" id="oprocentowanie" placeholder="np. 7.5" value="{$oprocentowanie|default:''}" />
                </div>
        ...
        <div style="max-width: 600px; margin: 30px auto 0 auto; text-align: left;">
            ...
            {if isset($result)}
                <div style="padding: 20px; background-color: #e6ffe6; border-left: 5px solid #33cc33; border-radius: 4px; text-align: center;">
                    <h3 style="color: #009900; margin: 0;">Miesięczna rata wynosi: <br><span style="font-size: 1.5em;">{$result|number_format:2:',':' '} zł</span></h3>
                </div>
            {/if}
